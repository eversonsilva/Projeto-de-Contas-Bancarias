...
public class ArquivoLog {
    ...
    public ArquivoLog(String dh, int no, String idServidorNegocio, String o, String conta, String valor) {
        //Construtor recebe como parametro o que vai ser escrito no arquivo Log.
        
        escreverLog(dh, no, idServidorNegocio, o, conta, valor);                                                  //Construtor já chama o método para montagem do arquivo.
    }
    
    private void escreverLog(String dh, int no, String idServidorNegocio, String o, String conta, String valor){  //Método que recebe como parâmetro o que vai ser escrito no arquivo e o responsável por montar o arquivo.
        try {
            
            arq = new File("C:\\Temp\\Logs_Dados.txt");                                                           //Criação do arquivo txt na partição C na pasta Temp.
            ...
            bw.write("Data e hora: "+dh + " | "); 
            bw.write("QTD "+no + " | "); 
            bw.write("Servidor: "+idServidorNegocio + " | ");
            bw.write("Operacao: "+ o + " | "); 
            bw.write("Conta: "+conta + " | "); 
            bw.write("Saldo: "+valor);
            ...
            try {
                arq.createNewFile();
                escreverLog(dh, no, idServidorNegocio, o, conta, valor);
